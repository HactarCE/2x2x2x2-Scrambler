...
var seq__3168_3172 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__3169_3173 = null;
var count__3170_3174 = (0);
var i__3171_3175 = (0);
while(true){
if((i__3171_3175 < count__3170_3174)){
var str_3176 = cljs.core._nth.call(null,chunk__3169_3173,i__3171_3175);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_3176})));


var G__3177 = seq__3168_3172;
var G__3178 = chunk__3169_3173;
var G__3179 = count__3170_3174;
var G__3180 = (i__3171_3175 + (1));
seq__3168_3172 = G__3177;
chunk__3169_3173 = G__3178;
count__3170_3174 = G__3179;
i__3171_3175 = G__3180;
continue;
} else {
var temp__4657__auto___3181 = cljs.core.seq.call(null,seq__3168_3172);
if(temp__4657__auto___3181){
var seq__3168_3182__$1 = temp__4657__auto___3181;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__3168_3182__$1)){
var c__4351__auto___3183 = cljs.core.chunk_first.call(null,seq__3168_3182__$1);
var G__3184 = cljs.core.chunk_rest.call(null,seq__3168_3182__$1);
var G__3185 = c__4351__auto___3183;
var G__3186 = cljs.core.count.call(null,c__4351__auto___3183);
var G__3187 = (0);
seq__3168_3172 = G__3184;
chunk__3169_3173 = G__3185;
count__3170_3174 = G__3186;
i__3171_3175 = G__3187;
continue;
} else {
var str_3188 = cljs.core.first.call(null,seq__3168_3182__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_3188})));


var G__3189 = cljs.core.next.call(null,seq__3168_3182__$1);
var G__3190 = null;
var G__3191 = (0);
var G__3192 = (0);
seq__3168_3172 = G__3189;
chunk__3169_3173 = G__3190;
count__3170_3174 = G__3191;
i__3171_3175 = G__3192;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__3197 = script;
goog.object.set(G__3197,"type","text/javascript");

goog.object.set(G__3197,"onload",onload);

goog.object.set(G__3197,"onreadystatechange",onload);

return G__3197;
})();
if((opt_sourceText == null)){
var G__3198 = script__$1;
goog.object.set(G__3198,"src",src);

return G__3198;
} else {
var G__3199 = script__$1;
goog.dom.setTextContext(G__3199,opt_sourceText);
...
var path_3200 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_3200);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_3200)].join(''));
} else {
var path_3201 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_3201);

goog.object.remove(goog.dependencies_.written,path_3201);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_3201)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR_3202 = clojure.browser.repl._STAR_repl_STAR_;
...
}finally {clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR_3202;
}})()})));
});})(connected_QMARK_,repl_connection))
);
