...
var G__3138 = o;
(G__3138[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__3139__delegate = function (args){
...
while (G__3140__i < G__3140__a.length) {G__3140__a[G__3140__i] = arguments[G__3140__i + 0]; ++G__3140__i;}
  args = new cljs.core.IndexedSeq(G__3140__a,0,null);
} 
return G__3139__delegate.call(this,args);};
G__3139.cljs$lang$maxFixedArity = 0;
G__3139.cljs$lang$applyTo = (function (arglist__3141){
var args = cljs.core.seq(arglist__3141);
return G__3139__delegate(args);
});
...
var G__3142 = o;
(G__3142[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__3143__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__3143 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__3144__i = 0, G__3144__a = new Array(arguments.length -  0);
while (G__3144__i < G__3144__a.length) {G__3144__a[G__3144__i] = arguments[G__3144__i + 0]; ++G__3144__i;}
  args = new cljs.core.IndexedSeq(G__3144__a,0,null);
} 
return G__3143__delegate.call(this,args);};
G__3143.cljs$lang$maxFixedArity = 0;
G__3143.cljs$lang$applyTo = (function (arglist__3145){
var args = cljs.core.seq(arglist__3145);
return G__3143__delegate(args);
});
G__3143.cljs$core$IFn$_invoke$arity$variadic = G__3143__delegate;
return G__3143;
})()
;
} else {
...
var G__3147 = props;
var G__3147__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__3147,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__3147);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__3147__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__3148){
var map__3149 = p__3148;
var map__3149__$1 = ((((!((map__3149 == null)))?(((((map__3149.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3149.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3149):map__3149);
var props = map__3149__$1;
var class$ = cljs.core.get.call(null,map__3149__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__3149,map__3149__$1,props,class$){
return (function (c){
...
});})(map__3149,map__3149__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__3151){
var map__3152 = p__3151;
var map__3152__$1 = ((((!((map__3152 == null)))?(((((map__3152.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3152.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3152):map__3152);
var on_write = cljs.core.get.call(null,map__3152__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__3152,map__3152__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__3152,map__3152__$1,on_write))
);
} else {
...
var G__3155 = jsprops;
(G__3155["defaultValue"] = value);

(G__3155["onChange"] = ((function (G__3155,v,value,on_change){
return (function (p1__3154_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__3154_SHARP_);
});})(G__3155,v,value,on_change))
);
...
var vec__3158 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__3158,(0),null);
var id = cljs.core.nth.call(null,vec__3158,(1),null);
var class$ = cljs.core.nth.call(null,vec__3158,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___3162 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___3162 == null)){
} else {
var key_3163 = temp__4661__auto___3162;
(jsprops["key"] = key_3163);
}
...
var temp__4661__auto___3164 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__4661__auto___3164 == null)){
} else {
var key_3165 = temp__4661__auto___3164;
reagent.impl.template.oset.call(null,jsprops,"key",key_3165);
}
...
var G__3166 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__3166["name"] = c);
...
args__4534__auto__.push((arguments[i__4532__auto___3172]));
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq3169){
var G__3170 = cljs.core.first.call(null,seq3169);
var seq3169__$1 = cljs.core.next.call(null,seq3169);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3170,seq3169__$1);
});
...
break;
default:
var G__3176 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__3176;
continue;
...
var n__4408__auto___3178 = a.length;
var i_3179 = (0);
while(true){
if((i_3179 < n__4408__auto___3178)){
(a[i_3179] = reagent.impl.template.as_element.call(null,(a[i_3179])));

var G__3180 = (i_3179 + (1));
i_3179 = G__3180;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___3181 = a.length;
var i_3182 = (0);
while(true){
if((i_3182 < n__4408__auto___3181)){
var val_3183 = (a[i_3182]);
if(((cljs.core.vector_QMARK_.call(null,val_3183)) && ((reagent.impl.template.key_from_vec.call(null,val_3183) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_3182] = reagent.impl.template.as_element.call(null,val_3183));
...
var ctx = ({});
var vec__3185 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__3185,(0),null);
var derefed = cljs.core.nth.call(null,vec__3185,(1),null);
...
var G__3188 = (cljs.core.count.call(null,argv) - first_child);
switch (G__3188) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__3188){
