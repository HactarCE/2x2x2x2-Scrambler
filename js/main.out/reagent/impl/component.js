...
if((i < len)){
var k = (ks[i]);
var G__5440 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__5441 = (i + (1));
m = G__5440;
i = G__5441;
continue;
...
var temp__4659__auto__ = (p["argv"]);
if((temp__4659__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__5442 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__5442) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__5442));
})());
} else {
var v = temp__4659__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__5444 = c;
var G__5444__$1 = (((G__5444 == null))?null:G__5444.prototype);
if((G__5444__$1 == null)){
return null;
} else {
return (G__5444__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__5446 = c;
var G__5446__$1 = (((G__5446 == null))?null:G__5446.prototype);
if((G__5446__$1 == null)){
return null;
} else {
return (G__5446__$1["render"]);
}
})() == null))));
});
...
var G__5448 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__5448) : reagent.impl.component.as_element.call(null,G__5448));
};
var G__5450 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5451__i = 0, G__5451__a = new Array(arguments.length -  0);
while (G__5451__i < G__5451__a.length) {G__5451__a[G__5451__i] = arguments[G__5451__i + 0]; ++G__5451__i;}
  args = new cljs.core.IndexedSeq(G__5451__a,0,null);
} 
return G__5450__delegate.call(this,args);};
G__5450.cljs$lang$maxFixedArity = 0;
G__5450.cljs$lang$applyTo = (function (arglist__5452){
var args = cljs.core.seq(arglist__5452);
return G__5450__delegate(args);
});
...
var _STAR_current_component_STAR_5454 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_5454;
}});
...
return ((function (G__5455,G__5455__$1){
...
var c = this;
var G__5460_5462 = (c["cljsRatom"]);
if((G__5460_5462 == null)){
} else {
reagent.ratom.dispose_BANG_(G__5460_5462);
}
...
var renders_5464 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_5465 = cljs.core.first(cljs.core.vals(renders_5464));
if((cljs.core.count(renders_5464) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_5464))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_5465)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_5465], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__5463 = name;
switch (G__5463) {
case "":
...
var G__5468 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__5468) : reagent.impl.component.global$module$create_react_class.call(null,G__5468));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__5469 = fiber;
var G__5469__$1 = (((G__5469 == null))?null:(G__5469["type"]));
if((G__5469__$1 == null)){
return null;
} else {
return (G__5469__$1["displayName"]);
}
})();
var parent = (function (){var G__5470 = fiber;
if((G__5470 == null)){
return null;
} else {
return (G__5470["return"]);
}
})();
var path = (function (){var G__5471 = parent;
var G__5471__$1 = (((G__5471 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__5471) : reagent.impl.component.fiber_component_path.call(null,G__5471)));
if((G__5471__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5471__$1)," > "].join('');
}
})();
...
var temp__4655__auto__ = (function (){var or__3949__auto__ = (function (){var G__5473 = c;
if((G__5473 == null)){
return null;
} else {
return (G__5473["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__5474._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__5476 = c;
if((G__5476 == null)){
return null;
} else {
return (G__5476["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__5478 = c;
if((G__5478 == null)){
return null;
} else {
return G__5478._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__5480 = instance;
if((G__5480 == null)){
return null;
} else {
return (G__5480["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__5481 = instance;
if((G__5481 == null)){
return null;
} else {
return G__5481._currentElement;
}
}
})();
var name = (function (){var G__5482 = elem;
var G__5482__$1 = (((G__5482 == null))?null:(G__5482["type"]));
if((G__5482__$1 == null)){
return null;
} else {
return (G__5482__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__5484 = elem;
if((G__5484 == null)){
return null;
} else {
return (G__5484["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__5485._owner;
}
}
})();
var path = (function (){var G__5486 = owner;
var G__5486__$1 = (((G__5486 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__5486) : reagent.impl.component.component_path.call(null,G__5486)));
if((G__5486__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5486__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__5487 = c;
var G__5487__$1 = (((G__5487 == null))?null:G__5487.constructor);
if((G__5487__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__5487__$1);
}
}
})();
