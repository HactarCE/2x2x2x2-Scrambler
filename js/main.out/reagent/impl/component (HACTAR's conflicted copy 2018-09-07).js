...
if((i < len)){
var k = (ks[i]);
var G__3091 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__3092 = (i + (1));
m = G__3091;
i = G__3092;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__3094 = c;
var G__3094__$1 = (((G__3094 == null))?null:G__3094.prototype);
if((G__3094__$1 == null)){
return null;
} else {
return (G__3094__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__3096 = c;
var G__3096__$1 = (((G__3096 == null))?null:G__3096.prototype);
if((G__3096__$1 == null)){
return null;
} else {
return (G__3096__$1["render"]);
}
})() == null))));
});
...
var G__3100__i = 0, G__3100__a = new Array(arguments.length -  0);
while (G__3100__i < G__3100__a.length) {G__3100__a[G__3100__i] = arguments[G__3100__i + 0]; ++G__3100__i;}
  args = new cljs.core.IndexedSeq(G__3100__a,0,null);
} 
return G__3099__delegate.call(this,args);};
G__3099.cljs$lang$maxFixedArity = 0;
G__3099.cljs$lang$applyTo = (function (arglist__3101){
var args = cljs.core.seq(arglist__3101);
return G__3099__delegate(args);
});
G__3099.cljs$core$IFn$_invoke$arity$variadic = G__3099__delegate;
return G__3099;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR_3103 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_3103;
}});
...
var G__3104 = key;
var G__3104__$1 = (((G__3104 instanceof cljs.core.Keyword))?G__3104.fqn:null);
switch (G__3104__$1) {
...
return ((function (G__3104,G__3104__$1){
...
var c = this;
var G__3109_3111 = (c["cljsRatom"]);
if((G__3109_3111 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__3109_3111);
}
...
var renders_3113 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_3114 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_3113));
if((cljs.core.count.call(null,renders_3113) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_3113))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_3114)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_3114))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__3112 = name;
switch (G__3112) {
case "":
...
var G__3116 = o;
(G__3116[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__3117 = fiber;
var G__3117__$1 = (((G__3117 == null))?null:(G__3117["type"]));
if((G__3117__$1 == null)){
return null;
} else {
return (G__3117__$1["displayName"]);
}
})();
var parent = (function (){var G__3118 = fiber;
if((G__3118 == null)){
return null;
} else {
return (G__3118["return"]);
}
})();
var path = (function (){var G__3119 = parent;
var G__3119__$1 = (((G__3119 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__3119));
if((G__3119__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3119__$1)," > "].join('');
}
})();
...
var temp__4655__auto__ = (function (){var or__3949__auto__ = (function (){var G__3121 = c;
if((G__3121 == null)){
return null;
} else {
return (G__3121["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__3122._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__3124 = c;
if((G__3124 == null)){
return null;
} else {
return (G__3124["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__3126 = c;
if((G__3126 == null)){
return null;
} else {
return G__3126._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__3128 = instance;
if((G__3128 == null)){
return null;
} else {
return (G__3128["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__3129 = instance;
if((G__3129 == null)){
return null;
} else {
return G__3129._currentElement;
}
}
})();
var name = (function (){var G__3130 = elem;
var G__3130__$1 = (((G__3130 == null))?null:(G__3130["type"]));
if((G__3130__$1 == null)){
return null;
} else {
return (G__3130__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__3132 = elem;
if((G__3132 == null)){
return null;
} else {
return (G__3132["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__3133._owner;
}
}
})();
var path = (function (){var G__3134 = owner;
var G__3134__$1 = (((G__3134 == null))?null:reagent.impl.component.component_path.call(null,G__3134));
if((G__3134__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3134__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__3135 = c;
var G__3135__$1 = (((G__3135 == null))?null:G__3135.constructor);
if((G__3135__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__3135__$1);
}
}
})();
