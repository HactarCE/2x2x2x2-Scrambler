...
var G__5505 = o;
(G__5505[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__5506__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__5506 = function (var_args){
var args = null;
...
while (G__5507__i < G__5507__a.length) {G__5507__a[G__5507__i] = arguments[G__5507__i + 0]; ++G__5507__i;}
  args = new cljs.core.IndexedSeq(G__5507__a,0,null);
} 
return G__5506__delegate.call(this,args);};
G__5506.cljs$lang$maxFixedArity = 0;
G__5506.cljs$lang$applyTo = (function (arglist__5508){
var args = cljs.core.seq(arglist__5508);
return G__5506__delegate(args);
});
G__5506.cljs$core$IFn$_invoke$arity$variadic = G__5506__delegate;
return G__5506;
})()
;
} else {
...
var G__5509 = o;
(G__5509[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__5510__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__5510 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5511__i = 0, G__5511__a = new Array(arguments.length -  0);
while (G__5511__i < G__5511__a.length) {G__5511__a[G__5511__i] = arguments[G__5511__i + 0]; ++G__5511__i;}
  args = new cljs.core.IndexedSeq(G__5511__a,0,null);
} 
return G__5510__delegate.call(this,args);};
G__5510.cljs$lang$maxFixedArity = 0;
G__5510.cljs$lang$applyTo = (function (arglist__5512){
var args = cljs.core.seq(arglist__5512);
return G__5510__delegate(args);
});
...
var G__5514 = props;
var G__5514__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5514,cljs.core.cst$kw$id,id):G__5514);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5514__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__5515){
...
var props = map__5516__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5516__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__5516,map__5516__$1,props,class$){
return (function (c){
...
});})(map__5516,map__5516__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__5518){
var map__5519 = p__5518;
var map__5519__$1 = ((((!((map__5519 == null)))?(((((map__5519.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5519.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5519):map__5519);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5519__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__5519,map__5519__$1,on_write){
return (function (){
...
});})(node_value,map__5519,map__5519__$1,on_write))
);
} else {
...
var G__5522 = jsprops;
(G__5522["defaultValue"] = value);

(G__5522["onChange"] = ((function (G__5522,v,value,on_change){
return (function (p1__5521_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5521_SHARP_);
});})(G__5522,v,value,on_change))
);
...
var vec__5525 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5525,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5525,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5525,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___5529 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___5529 == null)){
} else {
var key_5530 = temp__4661__auto___5529;
(jsprops["key"] = key_5530);
}
...
var temp__4661__auto___5531 = reagent.impl.template.key_from_vec(argv);
if((temp__4661__auto___5531 == null)){
} else {
var key_5532 = temp__4661__auto___5531;
reagent.impl.template.oset(jsprops,"key",key_5532);
}
...
var G__5533 = reagent.impl.template.__GT_NativeWrapper();
(G__5533["name"] = c);
...
var G__5534 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5534) : reagent.impl.template.as_element.call(null,G__5534));
} else {
...
var len__4531__auto___5539 = arguments.length;
var i__4532__auto___5540 = (0);
while(true){
if((i__4532__auto___5540 < len__4531__auto___5539)){
args__4534__auto__.push((arguments[i__4532__auto___5540]));

var G__5541 = (i__4532__auto___5540 + (1));
i__4532__auto___5540 = G__5541;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq5537){
var G__5538 = cljs.core.first(seq5537);
var seq5537__$1 = cljs.core.next(seq5537);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5538,seq5537__$1);
});
...
break;
default:
var G__5544 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__5544;
continue;
...
var n__4408__auto___5546 = a.length;
var i_5547 = (0);
while(true){
if((i_5547 < n__4408__auto___5546)){
(a[i_5547] = reagent.impl.template.as_element((a[i_5547])));

var G__5548 = (i_5547 + (1));
i_5547 = G__5548;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___5549 = a.length;
var i_5550 = (0);
while(true){
if((i_5550 < n__4408__auto___5549)){
var val_5551 = (a[i_5550]);
if(((cljs.core.vector_QMARK_(val_5551)) && ((reagent.impl.template.key_from_vec(val_5551) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_5550] = reagent.impl.template.as_element(val_5551));

var G__5552 = (i_5550 + (1));
i_5550 = G__5552;
continue;
} else {
}
...
var ctx = ({});
var vec__5553 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5553,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5553,(1),null);
...
var G__5556 = (cljs.core.count(argv) - first_child);
switch (G__5556) {
case (0):
...
var G__5557 = comp;
var G__5558 = jsprops;
var G__5559 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__5557,G__5558,G__5559) : reagent.impl.template.global$module$react.createElement.call(null,G__5557,G__5558,G__5559));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__5556){
