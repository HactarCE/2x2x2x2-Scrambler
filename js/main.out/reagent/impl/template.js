...
var G__2016 = o;
(G__2016[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__2017__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__2017 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__2018__i = 0, G__2018__a = new Array(arguments.length -  0);
while (G__2018__i < G__2018__a.length) {G__2018__a[G__2018__i] = arguments[G__2018__i + 0]; ++G__2018__i;}
  args = new cljs.core.IndexedSeq(G__2018__a,0,null);
} 
return G__2017__delegate.call(this,args);};
G__2017.cljs$lang$maxFixedArity = 0;
G__2017.cljs$lang$applyTo = (function (arglist__2019){
var args = cljs.core.seq(arglist__2019);
return G__2017__delegate(args);
});
G__2017.cljs$core$IFn$_invoke$arity$variadic = G__2017__delegate;
return G__2017;
})()
;
} else {
...
if(reagent.impl.template.named_QMARK_.call(null,k)){
var temp__4659__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.custom_prop_name_cache,cljs.core.name.call(null,k));
if((temp__4659__auto__ == null)){
...
var G__2020 = o;
(G__2020[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__2021__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__2021 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__2022__i = 0, G__2022__a = new Array(arguments.length -  0);
while (G__2022__i < G__2022__a.length) {G__2022__a[G__2022__i] = arguments[G__2022__i + 0]; ++G__2022__i;}
  args = new cljs.core.IndexedSeq(G__2022__a,0,null);
} 
return G__2021__delegate.call(this,args);};
G__2021.cljs$lang$maxFixedArity = 0;
G__2021.cljs$lang$applyTo = (function (arglist__2023){
var args = cljs.core.seq(arglist__2023);
return G__2021__delegate(args);
});
G__2021.cljs$core$IFn$_invoke$arity$variadic = G__2021__delegate;
return G__2021;
})()
;
} else {
...
var G__2025 = props;
var G__2025__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__2025,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__2025);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2025__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__2026){
var map__2027 = p__2026;
var map__2027__$1 = ((((!((map__2027 == null)))?(((((map__2027.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2027.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2027):map__2027);
var props = map__2027__$1;
var class$ = cljs.core.get.call(null,map__2027__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__2027,map__2027__$1,props,class$){
return (function (c){
...
});})(map__2027,map__2027__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__2029){
...
var on_write = cljs.core.get.call(null,map__2030__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__2030,map__2030__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__2030,map__2030__$1,on_write))
);
} else {
...
var G__2033 = jsprops;
(G__2033["defaultValue"] = value);

(G__2033["onChange"] = ((function (G__2033,v,value,on_change){
return (function (p1__2032_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__2032_SHARP_);
});})(G__2033,v,value,on_change))
);
...
var vec__2036 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__2036,(0),null);
var id = cljs.core.nth.call(null,vec__2036,(1),null);
var class$ = cljs.core.nth.call(null,vec__2036,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___2040 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___2040 == null)){
} else {
var key_2041 = temp__4661__auto___2040;
(jsprops["key"] = key_2041);
}
...
var temp__4661__auto___2042 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__4661__auto___2042 == null)){
} else {
var key_2043 = temp__4661__auto___2042;
reagent.impl.template.oset.call(null,jsprops,"key",key_2043);
}
...
var G__2044 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__2044["name"] = c);
...
var len__4531__auto___2049 = arguments.length;
var i__4532__auto___2050 = (0);
while(true){
if((i__4532__auto___2050 < len__4531__auto___2049)){
args__4534__auto__.push((arguments[i__4532__auto___2050]));

var G__2051 = (i__4532__auto___2050 + (1));
i__4532__auto___2050 = G__2051;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq2047){
var G__2048 = cljs.core.first.call(null,seq2047);
var seq2047__$1 = cljs.core.next.call(null,seq2047);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2048,seq2047__$1);
});
...
break;
default:
var G__2054 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__2054;
continue;
...
var n__4408__auto___2056 = a.length;
var i_2057 = (0);
while(true){
if((i_2057 < n__4408__auto___2056)){
(a[i_2057] = reagent.impl.template.as_element.call(null,(a[i_2057])));

var G__2058 = (i_2057 + (1));
i_2057 = G__2058;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___2059 = a.length;
var i_2060 = (0);
while(true){
if((i_2060 < n__4408__auto___2059)){
var val_2061 = (a[i_2060]);
if(((cljs.core.vector_QMARK_.call(null,val_2061)) && ((reagent.impl.template.key_from_vec.call(null,val_2061) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_2060] = reagent.impl.template.as_element.call(null,val_2061));

var G__2062 = (i_2060 + (1));
i_2060 = G__2062;
continue;
} else {
}
...
var ctx = ({});
var vec__2063 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__2063,(0),null);
var derefed = cljs.core.nth.call(null,vec__2063,(1),null);
...
var G__2066 = (cljs.core.count.call(null,argv) - first_child);
switch (G__2066) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__2066){
