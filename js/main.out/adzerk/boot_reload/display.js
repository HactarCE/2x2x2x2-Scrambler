...
return (function (p__1137){
var vec__1138 = p__1137;
var attr = cljs.core.nth.call(null,vec__1138,(0),null);
var v = cljs.core.nth.call(null,vec__1138,(1),null);
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,attr)),":",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),";"].join('');
});})(rules__$1))
;
...
var len__4531__auto___1145 = arguments.length;
var i__4532__auto___1146 = (0);
while(true){
if((i__4532__auto___1146 < len__4531__auto___1145)){
args__4534__auto__.push((arguments[i__4532__auto___1146]));

var G__1147 = (i__4532__auto___1146 + (1));
i__4532__auto___1146 = G__1147;
continue;
} else {
}
break;
...
/** @this {Function} */
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq1144){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq1144));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__1148){
var map__1149 = p__1148;
var map__1149__$1 = ((((!((map__1149 == null)))?(((((map__1149.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1149.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1149):map__1149);
var data = map__1149__$1;
var message = cljs.core.get.call(null,map__1149__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__1149__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__1149__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__1151 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__1151,goog.events.EventType.CLICK,((function (G__1151,map__1149,map__1149__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__1151,map__1149,map__1149__$1,data,message,line,file))
);

return G__1151;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__1152){
var map__1153 = p__1152;
var map__1153__$1 = ((((!((map__1153 == null)))?(((((map__1153.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1153.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1153):map__1153);
var data = map__1153__$1;
var message = cljs.core.get.call(null,map__1153__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__1153__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__1153__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__1155 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),["at line ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__1155,goog.events.EventType.CLICK,((function (G__1155,map__1153,map__1153__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__1155,map__1153,map__1153__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__1156){
var map__1157 = p__1156;
...
var messages = map__1157__$1;
var warnings = cljs.core.get.call(null,map__1157__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__1157__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__1159 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__1159,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__1159,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__1160){
var map__1161 = p__1160;
var map__1161__$1 = ((((!((map__1161 == null)))?(((((map__1161.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1161.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1161):map__1161);
var messages = map__1161__$1;
var warnings = cljs.core.get.call(null,map__1161__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__1161__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__1161,map__1161__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__1161,map__1161__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = ((cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings))));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__1161,map__1161__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__1161,map__1161__$1,messages,warnings,exception))
;
...
return ["boot-reload-hud-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,cljs.core.gensym.call(null)))].join('');
});
if((typeof adzerk !== 'undefined') && (typeof adzerk.boot_reload !== 'undefined') && (typeof adzerk.boot_reload.display !== 'undefined') && (typeof adzerk.boot_reload.display.current_container !== 'undefined')){
} else {
...
}catch (e1163){if((e1163 instanceof Error)){
var __1164 = e1163;
} else {
throw e1163;
