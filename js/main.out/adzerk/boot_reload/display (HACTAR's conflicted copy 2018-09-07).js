...
return (function (p__1388){
var vec__1389 = p__1388;
var attr = cljs.core.nth.call(null,vec__1389,(0),null);
var v = cljs.core.nth.call(null,vec__1389,(1),null);
...
var len__4531__auto___1396 = arguments.length;
var i__4532__auto___1397 = (0);
while(true){
if((i__4532__auto___1397 < len__4531__auto___1396)){
args__4534__auto__.push((arguments[i__4532__auto___1397]));

var G__1398 = (i__4532__auto___1397 + (1));
i__4532__auto___1397 = G__1398;
continue;
} else {
}
break;
...
/** @this {Function} */
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq1395){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq1395));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__1399){
var map__1400 = p__1399;
var map__1400__$1 = ((((!((map__1400 == null)))?(((((map__1400.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1400.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1400):map__1400);
var data = map__1400__$1;
var message = cljs.core.get.call(null,map__1400__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__1400__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__1400__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__1402 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__1402,goog.events.EventType.CLICK,((function (G__1402,map__1400,map__1400__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__1402,map__1400,map__1400__$1,data,message,line,file))
);

return G__1402;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__1403){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__1407){
var map__1408 = p__1407;
var map__1408__$1 = ((((!((map__1408 == null)))?(((((map__1408.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1408.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1408):map__1408);
var messages = map__1408__$1;
var warnings = cljs.core.get.call(null,map__1408__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__1408__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__1410 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__1410,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__1410,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__1411){
...
var messages = map__1412__$1;
var warnings = cljs.core.get.call(null,map__1412__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__1412__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__1412,map__1412__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__1412,map__1412__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = ((cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings))));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__1412,map__1412__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__1412,map__1412__$1,messages,warnings,exception))
;
...
}catch (e1414){if((e1414 instanceof Error)){
var __1415 = e1414;
} else {
throw e1414;
